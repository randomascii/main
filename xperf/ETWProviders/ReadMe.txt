...
As a sample of how to use this DLL see XperfUI, also available at https://github.com/randomascii/main.

XperfUI is also the recommended way to record traces that are using this DLL since it
